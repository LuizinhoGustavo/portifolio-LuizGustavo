...
export function Projects() {
    ...
    return (
        <div>
            ...
            <Project title="Random Gutenberg Book" imageProj={randomGutenbergImg} details='"Random Gutenberg Book" é um projeto com o intuito de aprender sobre React e requisições HTTP, utilizando uma Api pública o site requisita informações sobre um livro aleatório na base de dados com mais de 70.000 opções, dando informações sobre o Autor, a Capa e tópicos do livro além de disponilibilizar o link de acesso ao livro'
